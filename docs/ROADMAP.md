...
## Operations Release
Production authentication/RBAC; customer locations; product/commodity library; carrier-contract credentials; live rating; quote booking; pickup dispatch; BOL/labels; tracking normalization; exception queue; POD/document center; email notifications.

## Financial Release
Carrier invoice import/API; freight audit; duplicate-invoice prevention; accessorial approval queue; rebill rules; customer invoices; QuickBooks sync; accounts receivable status; margin-variance alerts.
